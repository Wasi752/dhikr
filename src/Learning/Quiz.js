...
function Quiz({showHadith}) {
    ...
    return (
        <div className= "flex items-center justify-center flex-[25] w-[25vw] mt-10 h-[90vh] sticky top-0">
            <div className= "flex flex-col items-center justify-center border-[1px] border-[#41B6BD] rounded-xl w-[35vw] h-[98vh] m-[10px] pt-[5px] pb-[5px] pl-[10px] pr-[10px] relative overflow-hidden bg-[#FFFFFF]">
